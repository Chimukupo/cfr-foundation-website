      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            <h3 className="text-amber-500 font-bold uppercase tracking-widest text-sm mb-4">About CareFirst</h3>
            ...
            <div className="w-16 h-1.5 bg-amber-500 my-8"></div>
            ...
            <Button className="bg-amber-500 hover:bg-amber-600 text-white font-bold px-8 py-6 rounded-none mt-6 uppercase tracking-wider transition-transform hover:scale-105 shadow-md">
              Read More
            </Button>
          </div>
          ...
          <div className="lg:col-span-7 relative pl-0 lg:pl-12 mt-10 lg:mt-0">
            ...
            <div className="absolute -left-6 -top-6 w-3/4 h-3/4 bg-amber-500/10 rounded-3xl -z-10 hidden lg:block"></div>
            
            <div className="flex flex-col space-y-4 items-end">
              <div className="text-center w-full mb-6 relative">
                 <h4 className="text-amber-500 font-bold text-lg mb-1 tracking-wide uppercase">In A Mission Since 2010</h4>
                 <h2 className="text-2xl md:text-3xl text-slate-900 dark:text-white font-bold">To help the Helpless and uplift the Society</h2>
              </div>

              <div className="relative rounded-2xl overflow-hidden shadow-2xl aspect-[4/3] w-full bg-slate-200 group">
                <img 
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                  <div className="w-20 h-20 md:w-24 md:h-24 bg-amber-500 rounded-full flex items-center justify-center cursor-pointer shadow-lg shadow-amber-500/30 hover:scale-110 transition-transform duration-300">
                    <PlayCircle className="text-white w-10 h-10 md:w-12 md:h-12 fill-white bg-transparent" />
                  </div>
                </div>
              </div>
            </div>
